...
A Swift sample code to reads ISO 10303-21 exchange structures (STEP P21 files for AP242) split into multiple files using [external references](https://www.cax-if.org/cax/cax_recommPractice.php "CAx recommended practices") approach.
